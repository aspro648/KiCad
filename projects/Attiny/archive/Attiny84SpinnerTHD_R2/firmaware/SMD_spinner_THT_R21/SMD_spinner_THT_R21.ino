...
int LEDS[] = {0, 1, 2, 3, 4, 5, 6, 7};   // Port A
...
byte magPin = 2;     // PB2/INTO Hall effect sensor, pulled-up, goes low when magnet passes      
byte buttonPin = 0;  // PB0 Tactile button, pulled up        
